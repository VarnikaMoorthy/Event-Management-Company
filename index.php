...
<head>
    ...
    <link rel="icon" href="#">
    <title>Thunde Event Production</title>
    <!-- Bootstrap core CSS -->
        ...
        <section class="hero bg-image" data-image-src="images/img/main.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Thunder Evetnz Mgmt  </h1>
                    <h5 class="font-white space-xs">Find Your Event, choose, and reach us</h5>
                    ...
                    <!-- <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Category</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>We arrange events you pick..</h2>
                    <p class="lead">The easiest way to your favourite event management</p>
                </div>
                <div class="row">
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with list of events to assist you.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve have managed to deliver all your required services.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>We are delighted to receive your bookings! And it"s our gratitude to service you!!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay by cash on Bookings</p>
                    </div>
                </div>
            </div>
        </section>
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['c_id'].'" >'.$rows['c_name'].'</a></h5> <span>'.$rows['address'].'</span>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="#" alt="Right Image" class="img-fluid"> </figure>
                            </div>
