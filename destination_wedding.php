    ...
    <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne">Basic Package</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#myAccordion">
                <div class="card-body">
                    <p>
                    <h4> Stage & Backdrop decor </h4>
                    <h4> Stage Setup </h4>
                    <h4> Photography </h4>
                    <h4> Traditional Photo &amp; Videography </h4>
                    <h4> 90 Page Album </h4>
                    <h4> 2 Photo Frame </h4>
                    <h4> Food </h4>
                    <li> 200 Members- Dinner / Breakfast / Lunch
                    <li> 12 Item(s) starting from - 150000
