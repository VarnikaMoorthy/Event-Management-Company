    ...
    <div class="accordion" id="myAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne">Corporate Event</button>									
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#myAccordion">
                <div class="card-body">
                    <p>
                    <h4> Audio and DJ setup </h4>
                    <h4> Hest [corporate] </h4>
                    <h4> Photography & Videography </h4>
                    <h4> Food </h4>
                    <li> 100 Members 
                    <h4> Welcome Girls </h4>
                    <li> Dance starting from - 1,40,000/- </li>
